...
@section('content')
    ...
    <div id="demo1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/1.jpg" alt="1" width="1450" height="600">
            </div>
            <div class="carousel-item">
                <img src="images/2.jpg" alt="2" width="1450" height="600">
            </div>
            <div class="carousel-item">
                <img src="images/3.jpg" alt="3" width="1450" height="600">
            </div>
        </div>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <!-- Walang Picture na Carousel -->
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div style="margin-left: 10px;" class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/image1.jpg" alt=" " width="1100" height="500">
                        ...
                        <div class="carousel-item">
                            <img src="images/image2.jpg" alt=" " width="1100" height="500">
                            <div class="col" style="background-color:transparent;">
                                <p>Highly Succeed Accounts Managers are very reachable, receptive on all the requests,
                                    hands-on, and very helpful.<br>
                                    Always meets our Business Requirements and we're very satisfied with it. They are one of
                        ...
                        <div class="carousel-item">
                            <img src="images/image3.jpg" alt="   " width="1100" height="500">
                            <div class="col" style="background-color:transparent;">
                ...
                <div class="col-md-3">
                    <h1 style="color: #caa40c;">What people says About us</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6" >
            <img src="images/transformurbusiness.png" width="710px;">
        </div>
        <div class="col-md-6" >
            <video onclick="this.play()" style="margin-left: -7px; margin-top: -14px;" width="690" 
              height="620"              poster="images/videoposter.png">
                <source src="images/company_profile.mp4" type="video/mp4">
            </video>
        </div>
    </div>
    <br>
    ...
    <div class="container">
  	 	<h1 style="color: #caa40c;"><center> Services We Provided</center> </h1>
  	 	<br>
  		 <br>
 			...
 			<div class="col-md-4">
 				<div class="card" style="width: 22rem;">
 					<img class="card-img-top" src="images/s1.png" alt="Card image cap">
 						...
 						<p class="card-text" style="text-align:center; color: gray;">Stay up-to-date and keep your productivity streak with Office 365 from Microsoft.</p>
 			</div>
 			<div class="col-md-4">
 				<div class="card" style="width: 22rem;">
 					...
 					<br>
 						...
 						<p class="card-text" style="text-align:center; color: gray;">Establish your brand’s online presence with a website custom-made to your liking.</p>
 			</div>
 			<div class="col-md-4">
 				<div class="card" style="width: 22rem;">
 				...
 				<p class="card-text" style="text-align:center; color: gray;">Utilize your applications anytime and anywhere. Thank us later.</p>
 			</div>
 		</div>
 		<br>
 		<br>
 			...
 			<div class="col-md-4">
 				<div class="card" style="border-radius: 5px;" style="width: 22rem;">
 					<img class="card-img-top" src="images/s4.png" alt="Card image cap">
 						...
 						<p class="card-text" style="text-align:center; color: gray;">Integrating information to endorse our product. Advertising through trend setting social media and information laying SEO's (Search Engine...</p>
 			</div>
 			<div class="col-md-4">
 				<div class="card" style="width: 22rem;">
 					...
 					<br>
 						...
 						<p class="card-text" style="text-align:center; color: gray;">We’ll help your sole imagination turn into a visual that can be seen by many.</p>
 			</div>
 			<div class="col-md-4">
 				<div class="card" style="width: 22rem;">
 				...
 				<p class="card-text" style="text-align:center; color: gray;">Bringing you the latest trend of cloud-storage for stability and long-term adaptability.</p>
 			</div>
 		</div>
     ...
     <div class="container latest-news-container">
        ...
        <div class="d-flex justify-content-center text-center">
            <div>
                <img src="images/first_news.jpg" alt="">
            ...
            <div>
                <img src="images/second_news.jpg" alt="">
            ...
            <div>
                <img src="images/third_news.jpg" alt="">
